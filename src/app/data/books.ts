...
export const books: Book[] = [
  ...
  {
    id: '46',
    title: 'Amana Bootcamp Book',
    author: 'Eng. Mohammed Zuqlam',
    description: 'This is a test description for the Amana Bootcamp book.',
    price: 200.45,
    image: '/images/book3.jpg',
    isbn: '978-4567890123',
    genre: ['Web', 'Computer Science', 'Programming'],
    tags: ['Information Theory', 'Programming'],
    datePublished: '2025-09-23',
    pages: 500,
    language: 'English',
    publisher: 'Amana Bootcamp',
    rating: 4.7,
    reviewCount: 20,
    inStock: true,
    featured: true,
